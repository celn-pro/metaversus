  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        really the
        <span className='font-extrabold text-white'> madnesss of the meaverse </span>
        of today, using only
        <span className='font-extrabold text-white'> VR </span>
        devices you can easilly explore
        the metaverse world you want, turn your
        dreams into realit. Let's
